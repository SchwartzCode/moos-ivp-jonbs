...
class HazardMgrX : public AppCastingMOOSApp
{
 ...
 protected: // Registration, Configuration, Mail handling utils
   ...
   void handleMailFoundPoints(std::string);
 ...
 private: // State variables
   ...
   XYHazardSet m_final_hazard_set;
   XYPolygon   m_search_region;
   
   std::string m_other_comm_report;
   std::string m_other_community;
   bool m_returning;
   bool m_first_iterate;
